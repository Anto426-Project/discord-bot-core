export type DiscordModerationPermission = "manage_messages" | "kick_members" | "ban_members";
...
export type DiscordModerationMemberFacts = DiscordModerationActorFacts & Readonly<{
    targetUserId: string;
...
export type DiscordMessageCleanupReceipt = DiscordModerationOperationReceipt & Readonly<{
    guildId: string;
    channelId: string;
...
export type DiscordMemberModerationReceipt = DiscordModerationOperationReceipt & Readonly<{
    guildId: string;
    targetUserId: string;
...
export type DiscordBanMemberInput = DiscordKickMemberInput & Readonly<{
