...
export type DiscordEditableInteractionMessagePlan = Omit<DiscordInteractionMessagePlan, "visibility">;
...
export type DiscordChatInputInteraction = DiscordInteractionBase & Readonly<{
    kind: "chat_input";
    commandName: string;
    options: DiscordCommandOptionsPort;
}>;
export type DiscordButtonInteraction = DiscordInteractionBase & Readonly<{
    kind: "button";
    customId: string;
}>;
export type DiscordStringSelectInteraction = DiscordInteractionBase & Readonly<{
    kind: "string_select";
    customId: string;
    values: readonly string[];
}>;
export type DiscordUserSelectInteraction = DiscordInteractionBase & Readonly<{
    kind: "user_select";
    customId: string;
...
export type DiscordModalSubmitInteraction = DiscordInteractionBase & Readonly<{
    kind: "modal_submit";
    customId: string;
    fields: DiscordModalFieldsPort;
}>;
export type DiscordInteraction = DiscordButtonInteraction | DiscordChatInputInteraction | DiscordModalSubmitInteraction | DiscordStringSelectInteraction | DiscordUserSelectInteraction;
export type DiscordInteractionListener = (interaction: DiscordInteraction) => void | Promise<void>;
