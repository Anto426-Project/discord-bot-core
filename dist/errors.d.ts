export type DiscordCoreErrorCode = "DISCORD_INVALID_INPUT" | "DISCORD_PAYLOAD_REJECTED" | "DISCORD_CANCELLED" | "DISCORD_TIMEOUT" | "DISCORD_NETWORK_FAILURE" | "DISCORD_RATE_LIMITED" | "DISCORD_PROVIDER_FAILURE" | "DISCORD_CIRCUIT_OPEN" | "DISCORD_RESPONSE_INVALID" | "DISCORD_RESPONSE_TOO_LARGE";
