...
export type DiscordNativeAutoModKeywordPreset = "profanity" | "sexual_content" | "slurs";
export type DiscordNativeAutoModTrigger = Readonly<{
...
export type DiscordNativeAutoModAction = Readonly<{
    type: "block_message";
...
export type DiscordNativeAutoModUpdateInput = DiscordNativeAutoModCreateInput & Readonly<{
    providerRuleId: string;
}>;
...
export type DiscordNativeAutoModMutationReceipt = DiscordAutoModOperationReceipt & Readonly<{
    guildId: string;
    providerRuleId: string;
}>;
