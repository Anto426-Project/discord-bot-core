import type { DiscordGuildMemberSnapshot, DiscordGuildRoleSnapshot } from "./guild-directory.js";
...
export type DiscordGatewayNativeAutoModAction = "block_message" | "send_alert" | "timeout" | "block_member_interaction";
...
export type DiscordGatewayEvent = DiscordGatewayGuildEvent | DiscordGatewayMemberEvent | DiscordGatewayVoiceStateChangedEvent | DiscordGatewayMessageCreatedEvent | DiscordGatewayNativeAutoModExecutedEvent;
export type DiscordGatewayEventListener = (event: DiscordGatewayEvent) => void | Promise<void>;
